...
const RecentListings = () => {
    const listings = [
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1536376072261-38c75010e6c9?w=200&h=200&fit=crop",
            status: "Active",
            price: "$1,800",
            period: "/mo",
            views: 120,
            ...
            <table className="w-full">
                <thead>
                    <tr className="border-b border-neutral-50 text-left">
                        <th className="pb-3 text-xs font-bold text-neutral-400 uppercase tracking-wider pl-0">Property</th>
                        <th className="pb-3 text-xs font-bold text-neutral-400 uppercase tracking-wider">Status</th>
                        <th className="pb-3 text-xs font-bold text-neutral-400 uppercase tracking-wider">Price</th>
                        <th className="pb-3 text-xs font-bold text-neutral-400 uppercase tracking-wider">Views</th>
                        <th className="pb-3 text-xs font-bold text-neutral-400 uppercase tracking-wider">Actions</th>
                    </tr>
                </thead>
                        ...
                        <tr key={item.id} className="group">
                            <td className="py-4 pl-0">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-neutral-500 font-medium">{item.address}</div>
                                    </div>
                                </div>
                            </td>

                            <td className="py-4">
                                <span className={`px-2.5 py-1 rounded-md text-xs font-bold ${getStatusStyle(item.status)}`}>
                                    {item.status}
                                </span>
                            </td>
                            ...
                            <td className="py-4">
                                <div className="text-sm font-bold text-neutral-900">
                                    {item.price}<span className="text-neutral-400 text-xs font-medium">{item.period}</span>
                                </div>
                            </td>
