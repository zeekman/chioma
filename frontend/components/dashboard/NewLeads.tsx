    ...
    return (
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-neutral-100">
            <div className="flex items-center justify-between mb-4">
                <h3 className="text-xs font-bold text-neutral-900 uppercase tracking-wider">New Leads</h3>
                <span className="px-2 py-0.5 bg-blue-50 text-brand-blue text-[10px] font-bold rounded-full">3 New</span>
            </div>
                    ...
                    <div key={lead.id} className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-baseline mb-0.5">
                                <h4 className="text-sm font-bold text-neutral-900">{lead.name}</h4>
                                <span className="text-[10px] text-neutral-400">{lead.time}</span>
                            </div>
